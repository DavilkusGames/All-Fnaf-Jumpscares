...
public class YandexGames : MonoBehaviour
{
    ...
    [DllImport("__Internal")]
    private static extern string GetDeveloperLink();
    ...
    public static string DevLink { get; private set; }
    ...
    public void DevLinkLoaded(string link)
    {
        DevLink = link;
        Debug.Log("Developer Link: " + DevLink);
        GameManager.Instance?.DevLinkLoaded();
    }
    ...
    public void PromoActive()
    {
        ...
        GameManager.Instance?.PromoIsActive();
    }
